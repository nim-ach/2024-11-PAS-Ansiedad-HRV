...
When examining the effect of HSPS on the BAI-HRV relationship, we observed that after considering the marginal effect of high sensitivity profile on the influence of BAI scores, the aforementioned effects are practically irrelevant.

```{r}
m_3 <- readRDS(file = "../models/m_2_fit.RDS")
